            ...
            <div className="flex items-center w-1/3">
                <div className="relative w-full">
                    <input
                        ...
                        className="w-full min-w-[160px] pl-10 pr-4 py-2 rounded-lg bg-white dark:bg-dark-card text-dark dark:text-card outline-none text-xs sm:text-base"
                    />
                    <MagnifyingGlassIcon className="absolute left-2 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" />
                </div>
            </div>
