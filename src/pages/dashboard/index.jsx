    ...
    return (
        <main className="px-6 py-6 space-y-10 text-dark dark:text-card min-h-screen">
            ...
            <section className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="col-span-2 bg-gradient-to-r from-purple-700 to-pink-500 text-white px-8 py-4 rounded-2xl flex flex-col justify-between gap-3">
                ...
                <div className="bg-card dark:bg-dark-card rounded-2xl p-4 shadow grid grid-cols-2 col-span-2 gap-4">
                    <div className="h-full sm:h-[150px]">
                        <img
                        src={Images.nft3}
                        alt="NFT"
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2 sm:gap-3 text-xs">
                            <button className="flex-1 py-2 px-4 bg-primary text-white rounded-lg">Place a Bid</button>
                            <button className="flex-1 py-2 px-4 bg-custom-red text-white rounded-lg">Details</button>
                        </div>
                    </div>
                </div>
            </section>
