    ...
    return (
        <section className="w-full">
            <div className="w-full flex items-center justify-between mb-6">
                <h3 className="text-white font-semibold">Active Bids</h3>
                <button className="px-5 py-2 bg-primary rounded-lg">Place Bid</button>
            </div>
            <div className="overflow-x-auto">
                <table className="w-full text-left text-sm text-gray-400">
                    ...
                    <tbody className="divide-y divide-dark">
                        {bids.map((bid) => (
                            <tr key={bid.id} className="bg-dark hover:bg-dark-card transition rounded-xl">
                                ...
                                <td className="px-4 py-4 flex items-center gap-3">
                                    ...
                                    />
                                    <div>
                                        <h4 className="text-white font-medium">{bid.title}</h4>
                                        <p className="text-xs text-gray-400">{bid.user}</p>
                                    </div>
                                </td>
